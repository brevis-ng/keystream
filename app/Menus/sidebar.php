...
return [
    ...
    [
        ...
        'submenus' => [
            ...
            [
                'gate' => 'administrator.links.stream.index',
                'name' => 'Links',
                'description' => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit.',
                /**
                 * Declaration route Example
                 * ['administrator.account.admin.show', ['uuid-uuid-uuid', 'foo' => 'bar']] --> https://domain.com/administrator/account/admin/uuid-uuid-uuid?foo=bar
                 */
                'route' => ['administrator.links.stream.index', []],
                'isActive' => 'links/stream*',
                'id' => '',
                'gates' => [
                    [
                        'gate' => 'administrator.links.stream.create',
                        'title' => 'Create link',
                        'description' => 'User can create new link'
                    ],
                    [
                        'gate' => 'administrator.links.stream.update',
                        'title' => 'Update link',
                        'description' => 'User can update link'
                    ],
                    [
                        'gate' => 'administrator.links.stream.destroy',
                        'title' => 'Delete link',
                        'description' => 'User can delete link'
                    ]
                ],
            ]
